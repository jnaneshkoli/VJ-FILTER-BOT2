...
# This Is Force Subscribe Channels, also known as Auth Channels - Support Multiple Channels
auth_channels = environ.get('AUTH_CHANNEL', '') # give your force subscribe channel ids here separated by space
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in auth_channels.split()] if auth_channels else []
...
REACTIONS = ["🤝", "😇", "🤗", "😍", "👍", "🎅", "😐", "🥰", "🤩", "😱", "🤣", "😘", "👏", "😛", "😈", "🎉", "⚡️", "🫡", "🤓", "😎", "🏆", "🔥", "🤭", "🌚", "🆒", "👻", "😁"] #don't add any emoji reactions
...
# Movie Update Channel Configuration
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '0'))  # Add your movie update channel ID here
AUTO_POST_MOVIES = bool(environ.get('AUTO_POST_MOVIES', 'True'))  # Enable/disable auto posting
