...
async def verify_user(bot, userid, token):
    ...
    VERIFIED[user.id] = today + timedelta(hours=24)
    await bot.send_message(LOG_CHANNEL, f"User {user.mention} Verified. Token: {token}. Expires at: {VERIFIED[user.id]}")
